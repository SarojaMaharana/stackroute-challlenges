...
public class UserProfileServiceImpl implements UserProfileService {
	...
	@Autowired
	public UserProfileServiceImpl(RabbitTemplate rabbitTemplate, UserProfileRepository userProfileRepository) {
...
//		rabbitTemplate.convertAndSend("newuser_exchange", "newuser_routekey", user);
