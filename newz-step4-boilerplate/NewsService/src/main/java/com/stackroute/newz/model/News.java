...
public class News {
	...
	public News(int newsId, String title, String author, String description, Date publishedAt, String content, String url, String urlToImage, Reminder reminder, NewsSource newsSource) {
		this.newsId = newsId;
		this.title = title;
		this.author = author;
