...
public class NewsSourceServiceImpl implements NewsSourceService {
	...
	public List<NewsSource> getAllNewsSourceByUserId(String createdBy) {
	 ...
	 /* This method should be used to block NewsSource and used to send the message to RabbitMq*/

	@Override
	public boolean blockNewssource(String userId, String newssourceId) {
		return false;
	}
