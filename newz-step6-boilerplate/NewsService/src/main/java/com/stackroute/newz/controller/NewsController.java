...
public class NewsController {
	...
	@PostMapping
	public ResponseEntity<?> createNews(@RequestBody News newNews) {
		final boolean response = newsService.addNews(newNews);
		if(response)
	...
	public ResponseEntity<?> deleteByNewsId(@PathVariable("userId") String userId, @PathVariable("newsId") int newsId) throws NewsNotFoundExeption {
		final boolean response = newsService.deleteNews(userId, newsId);
		if(response)
	...
	public ResponseEntity<?> deleteAllNewsByUser(@PathVariable("userId") String userId) throws NewsNotFoundExeption {
	...
	public ResponseEntity<?> updateNews(@RequestBody News updatedNews, @PathVariable("userId") String userId, @PathVariable("newsId") int newsId) throws NewsNotFoundExeption {
	...
	public ResponseEntity<?> getNewsById(@PathVariable("userId") String userId, @PathVariable("newsId") int newsId) throws NewsNotFoundExeption {
