...
//	@GetMapping
//	public ResponseEntity<?> getNewsById(@RequestParam("newsId") int newsId) throws NewsNotExistsException {
//		return new ResponseEntity<>(newsService.getNews(newsId), HttpStatus.OK);
//	}
	@GetMapping("{newsId}")
	public ResponseEntity<?> getNewsById(@PathVariable("newsId") int newsId) throws NewsNotExistsException {
		return new ResponseEntity<>(newsService.getNews(newsId), HttpStatus.OK);
	}
	...
	@PostMapping
	public ResponseEntity<?> addNewNews(@RequestBody News newNews) throws NewsAlreadyExistsException {
		return new ResponseEntity<>(newsService.addNews(newNews), HttpStatus.CREATED);
	}
	...
	@PutMapping("{newsId}")
	public ResponseEntity<?> updateNews(@PathVariable int newsId, @RequestBody News updatedNews) throws NewsNotExistsException {
		updatedNews.setNewsId(newsId);
		return new ResponseEntity<>(newsService.updateNews(updatedNews), HttpStatus.OK);
	}
